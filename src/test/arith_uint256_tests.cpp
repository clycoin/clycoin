...
#define CHECKASSIGNCLYTOPERATOR(_A_,_B_,_OP_)                           \
...
BOOST_AUTO_TEST_CASE( bitwiseOperators )
{
    ...
    arith_uint256 TmpL;
    CHECKASSIGNCLYTOPERATOR(R1,R2,|)
    CHECKASSIGNCLYTOPERATOR(R1,R2,^)
    CHECKASSIGNCLYTOPERATOR(R1,R2,&)
    CHECKASSIGNCLYTOPERATOR(R1,Zero,|)
    CHECKASSIGNCLYTOPERATOR(R1,Zero,^)
    CHECKASSIGNCLYTOPERATOR(R1,Zero,&)
    CHECKASSIGNCLYTOPERATOR(R1,Max,|)
    CHECKASSIGNCLYTOPERATOR(R1,Max,^)
    CHECKASSIGNCLYTOPERATOR(R1,Max,&)
    CHECKASSIGNCLYTOPERATOR(Zero,R1,|)
    CHECKASSIGNCLYTOPERATOR(Zero,R1,^)
    CHECKASSIGNCLYTOPERATOR(Zero,R1,&)
    CHECKASSIGNCLYTOPERATOR(Max,R1,|)
    CHECKASSIGNCLYTOPERATOR(Max,R1,^)
    CHECKASSIGNCLYTOPERATOR(Max,R1,&)
