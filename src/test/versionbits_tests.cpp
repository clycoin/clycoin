...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    ...
    for (int i=0; i<(int) Consensus::MAX_VERSION_BITS_DEPLOYCLYTS; i++) {
        ...
        // overlap.)
        for (int j=i+1; j<(int) Consensus::MAX_VERSION_BITS_DEPLOYCLYTS; j++) {
...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    int64_t bit = mainnetParams.vDeployments[Consensus::DEPLOYCLYT_TESTDUMMY].bit;
    int64_t nStartTime = mainnetParams.vDeployments[Consensus::DEPLOYCLYT_TESTDUMMY].nStartTime;
    int64_t nTimeout = mainnetParams.vDeployments[Consensus::DEPLOYCLYT_TESTDUMMY].nTimeout;
