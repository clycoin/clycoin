...
#define BOOST_TEST_MODULE CLYCoin Test Suite

#include "test_clycoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_clycoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
