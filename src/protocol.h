...
extern const char *MASTERNODEPAYCLYTVOTE;
extern const char *MASTERNODEPAYCLYTSYNC;
...
enum ServiceFlags : uint64_t {
    ...
    // set by all CLY Coin nodes, and is unset by SPV clients or other peers that just want
    // network services but don't provide them.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // CLY Coin does not support this but a patch set called Bitcoin XT does.
    // See BIP 64 for details on how this is implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // CLY Coin nodes used to support this by default, without advertising this bit,
...
enum {
    ...
    MSG_TXLOCK_VOTE,
    MSG_SPORK,
    MSG_MASTERNODE_PAYCLYT_VOTE,
    MSG_MASTERNODE_PAYCLYT_BLOCK, // reusing, was MSG_MASTERNODE_SCANNING_ERROR previousely, was NOT used in 12.0
