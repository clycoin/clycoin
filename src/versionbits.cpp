...
const struct BIP9DeploymentInfo VersionBitsDeploymentInfo[Consensus::MAX_VERSION_BITS_DEPLOYCLYTS] = {
    {
        /*.name =*/ "testdummy",
        /*.gbt_force =*/ true,
...
{
    for (unsigned int d = 0; d < Consensus::MAX_VERSION_BITS_DEPLOYCLYTS; d++) {
        caches[d].clear();
    }
}
