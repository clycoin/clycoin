...
const char *MASTERNODEPAYCLYTVOTE="mnw";
const char *MASTERNODEPAYCLYTBLOCK="mnwb";
const char *MASTERNODEPAYCLYTSYNC="mnget";
...
static const char* ppszTypeName[] =
{
    ...
    NetMsgType::SPORK,
    NetMsgType::MASTERNODEPAYCLYTVOTE,
    NetMsgType::MASTERNODEPAYCLYTBLOCK, // reusing, was MNSCANERROR previousely, was NOT used in 12.0, we need this for inv
...
const static std::string allNetMessageTypes[] = {
    ...
    NetMsgType::MASTERNODEPAYCLYTVOTE,
    // NetMsgType::MASTERNODEPAYCLYTBLOCK, // there is no message for this, only inventory
    NetMsgType::MASTERNODEPAYCLYTSYNC,
    NetMsgType::MNANNOUNCE,
    NetMsgType::MNPING,
    NetMsgType::DSACCEPT,
    NetMsgType::DSVIN,
