    ...
    BOOST_FOREACH(CNode* pnode, vNodesCopy)
    {
        ...
        if(Params().NetworkIDString() == CBaseChainParams::REGTEST)
        {
            if(nRequestedMasternodeAttempt <= 2) {
                ...
                connman.PushMessage(pnode, NetMsgType::MASTERNODEPAYCLYTSYNC, nMnCount); //sync payment votes
        ...
        // NORMAL NETWORK MODE - TESTNET/MAINNET
        {
            ...
            // MNW : SYNC MASTERNODE PAYCLYT VOTES FROM OTHER CONNECTED CLIENTS
            ...
            if(nRequestedMasternodeAssets == MASTERNODE_SYNC_MNW) {
                ...
                connman.PushMessage(pnode, NetMsgType::MASTERNODEPAYCLYTSYNC, mnpayments.GetStorageLimit());
