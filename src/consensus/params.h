...
enum DeploymentPos
{
    DEPLOYCLYT_TESTDUMMY,
    DEPLOYCLYT_CSV, // Deployment of BIP68, BIP112, and BIP113.
    DEPLOYCLYT_DIP0001, // Deployment of DIP0001 and lower transaction fees.
    // NOTE: Also add new deployments to VersionBitsDeploymentInfo in versionbits.cpp
    MAX_VERSION_BITS_DEPLOYCLYTS
};
...
struct Params {
    ...
    BIP9Deployment vDeployments[MAX_VERSION_BITS_DEPLOYCLYTS];
