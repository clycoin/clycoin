...
void CDSNotificationInterface::UpdatedBlockTip(const CBlockIndex *pindexNew, const CBlockIndex *pindexFork, bool fInitialDownload)
{
    ...
    // Update global flags
    fDIP0001ActiveAtTip = (VersionBitsState(pindexNew, Params().GetConsensus(), Consensus::DEPLOYCLYT_DIP0001, versionbitscache) == THRESHOLD_ACTIVE);
    fDIP0001WasLockedIn = fDIP0001ActiveAtTip || (VersionBitsState(pindexNew, Params().GetConsensus(), Consensus::DEPLOYCLYT_DIP0001, versionbitscache) == THRESHOLD_LOCKED_IN);
