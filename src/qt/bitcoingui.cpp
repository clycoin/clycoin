    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CLY Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CLYCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and clycoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CLY Coin"), this);
    aboutAction->setStatusTip(tr("Show information about CLY Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CLY Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CLYCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CLYCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a clycoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CLY Coin help message to get a list with possible CLY Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CLY Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CLYCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("CLY Coin"); // default title
