    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CLY Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CLY Coin"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  clycoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CLYCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other clycoin, without having your coins ever leave your wallet. \
...
These denominations are 0.01 CLY, 0.1 CLY, 1 CLY and 10 CLY -- sort of like the paper money you use every day.</li> \
...
<li>When two other clycoin send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://cly-project.atlassian.net/wiki/display/DOC/PrivateSend\">https://cly-project.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CLY Coin is shutting down...") + "<br /><br />" +
