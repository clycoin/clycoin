    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CLY-light"), QVariant("light"));
    /*ui->theme->addItem(QString("CLY-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CLY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CLY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CLY-traditional"), QVariant("trad"));*/
