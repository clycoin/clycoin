...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CLYCoinNetwork") type = CLYCoinNetwork;
    if(strType == "CLYCoinNetworkVariable") type = CLYCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CLYCoinNetwork) s = "CLYCoinNetwork";
    if(type == CLYCoinNetworkVariable) s = "CLYCoinNetworkVariable";
