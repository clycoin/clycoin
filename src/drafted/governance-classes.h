 ...
 *
 *   // network
 *   CCLYCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.clycoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCLYCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCLYCoinNetwork(UniValue objIn)
    {
...
// // can be under: CLYCoinNetwork
// //   -- signature requirements : Key1(User)
// class CCLYCoinNetworkVariable : public CGovernanceObject
// {
// private:
