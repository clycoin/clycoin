...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT:    r = SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT:    return SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT")    return SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT:    return "SPORK_8_MASTERNODE_PAYCLYT_ENFORCECLYT";
