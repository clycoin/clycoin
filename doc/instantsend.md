...
This mechanism has been integrated into Bitcore-Node-CLYCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cly-project/insight-api-clycoin#web-socket-api](https://github.com/cly-project/insight-api-clycoin#web-socket-api)
* API: [https://github.com/cly-project/insight-api-clycoin#instantsend-transactions](https://github.com/cly-project/insight-api-clycoin#instantsend-transactions)
...
By default, the CLY Coin daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CLY Coin daemon:
