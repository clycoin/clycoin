...
CLY Coin is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as CLY Coin, where everyone uses
...
pay attention to for reviewers of CLY Coin code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CLY Coin uses tinyformat, which is type safe. Leave them out to avoid confusion
